...
const target_votes = BigNumber.from("12000000000000000000000000")
...
const target_votes = BigNumber.from("30000000000000000000000000")
...
async function main() {
    ...
    const board = LightQuestBoard.attach(LIGHT_BOARD_ADDRESS);
    ...
    console.log()
    console.log('Approving LightQuestBoard ...')
