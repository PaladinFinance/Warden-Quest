...
const gauge_address = "0xE61C1E33dF4921F8B4EF0ee3f7031b472AFB52cF"

const target_votes = ethers.utils.parseEther('10000')
...
const blacklist = ["0xE2763df5eAfe829705f2B49a713b887d3b208C02", "0x5f350bF5feE8e254D6077f8661E9C7B83a30364e"]
...
async function main() {
    ...
    const board = DarkQuestBoard.attach(DARK_BOARD_LIT_ADDRESS);
