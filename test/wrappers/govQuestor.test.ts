...
import { GovernanceQuestor } from "../../typechain/GovernanceQuestor";
...
describe('GovernanceQuestor contract tests', () => {
    ...
    before(async () => {
        ...
        [admin, governance, manager, gauge1, gauge2, receiver, user1, user2, user3] = await ethers.getSigners();

        boardFactory = await ethers.getContractFactory("QuestBoard");

        questorFactory = await ethers.getContractFactory("GovernanceQuestor");
    ...
    describe('createQuest', async () => {
        ...
        let questor2: GovernanceQuestor
